...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/offload-project/laravel-toggle.svg?style=flat-square)](https://packagist.org/packages/offload-project/laravel-toggle)
[![Tests](https://img.shields.io/github/actions/workflow/status/offload-project/laravel-toggle/tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/offload-project/laravel-toggle/actions/workflows/tests.yml)
[![Build](https://img.shields.io/github/actions/workflow/status/offload-project/laravel-toggle/release.yml?label=build&style=flat-square)](https://github.com/offload-project/laravel-toggle/actions/workflows/release.yml)
[![Total Downloads](https://img.shields.io/packagist/dt/offload-project/laravel-toggle.svg?style=flat-square)](https://packagist.org/packages/offload-project/laravel-toggle)
